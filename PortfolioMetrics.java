...
public class PortfolioMetrics extends FinancialFunctions {
    ...
    public String[] metricsToCsv() {
        String[] toReturn = { "alpha: "+alpha, "beta: "+beta, "sharpe: "+sharpeRatio, "maxDD: "+maxDrawdown, "PnL: "+totalPnL, "cash: "+cashBalances.get(cashBalances.size() - 1), "#ofWins: "+winners.size(), "#ofLosses: "+losers.size(), "avgWin: "+avgWin, "avgLoss: "+avgLoss };
        return toReturn;
    }
