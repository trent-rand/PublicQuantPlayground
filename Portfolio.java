...
public class Portfolio {
    ...
    public void exitPosition(double exitPrice, double RawPnL, Date closeDate) {
        ...
        if(position != 0) {
            ...
            double percentGain = activeTrade.size * RawPnL - 0.15; // Adjusting PnL to consider leverage and commissions and fees.
    ...
    public static void main(String[] args) {
        ...
        getInstance().output.SaveSession("Input_Today_Metrics");
